...
const Detail = () => {
    ...
    const routeParams = route.params as PointParam
    const [data, setData] = useState<Data>({} as Data)

    function navigateBack() { navigation.goBack() }

    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Gostaria de saber mais detalhes sobre a coleta de resíduos`)
    }
